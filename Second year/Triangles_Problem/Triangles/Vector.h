...
//
#ifndef TRIANGLES_VECTOR_H
#define TRIANGLES_VECTOR_H
...
public:
    ...
    friend Line& Line::Plane_intersection(Plane& plane1, Plane& plane2, Vec& vec1, Vec& vec2);
